...
transformer that delivered strong online A/B gains across Yandex products (e.g. +2.26%
Total Listening Time at Yandex Music, +1.7% GMV in e-commerce, +2% revenue in Ads
ranking), and I introduced FSDP training to scale recommender transformers up to 7
billion parameters.

Research interests
======
Information retrieval, conversational recommendation, large language models, generative
recommendation, in-text reasoning for recommendation, reinforcement learning, and the
mathematical foundations of deep learning.

Find me
======
You can reach me by [email](mailto:matfu21@yandex.ru) or find me on
[Google Scholar](https://scholar.google.com/citations?user=BDuvo3EAAAAJ&hl=ru),
[ORCID](https://orcid.org/0009-0004-0271-221X),
[GitHub](https://github.com/matfu-pixel),
